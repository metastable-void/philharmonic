...
pub struct ConnectorConfig {
    ...
    pub dispatch: HashMap<String, UpstreamConfig>,
...
pub struct RealmKeyConfig {
    pub kid: String,
    pub realm_id: String,
    /// Either a combined 2432-byte file (2400 ML-KEM secret bytes followed by
    /// 32 X25519 secret bytes), or the ML-KEM secret file when
    /// `x25519_private_key_path` is also set.
